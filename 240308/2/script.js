//input태그를 통해서 사용자에게 어떤 숫자를 받을 것 입니다
//사용자가 숫자를 입력한 후 "입력"버튼을 클릭하게 되면 다음과같은 조건에 따라
//아래와 같은 결과가 출력되도록 할 것 입니다
//만약 10보다 큰 숫자를 입력했다면 알림창을 통해서 10보다 작은 숫자를 입력하세요!라는 메세지를 출력
